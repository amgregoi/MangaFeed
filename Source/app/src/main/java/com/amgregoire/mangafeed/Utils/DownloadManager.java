...
//        mDbDbManga = LocalMangaRepository().getManga(mDbChapter.getMangaUrl());
...
//                                                                             .append("/")
//                                                                             .append(mDbDbManga.getTitle()
//                                                                                               .replaceAll("\\W", ""))
//                                                                             .append("-")
//                                                                             .append(mDbDbManga.get_id())
//                                                                             .append("/Ch")
...
//                DbManga lDbDbManga = MangaDB.getInstance().getManga(lId);
//                lResult.add(lDbDbManga);
//            }
//        }
//
//        return lResult;
